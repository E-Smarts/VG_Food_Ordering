...
<body>
    ...
    <div class="reg-container">
        <form action="/VG_Food_Ordering/auth/register.php" method="post">
            <div class="logo-details">
                <i class='bx bxs-store'></i>
                <span class="logo_name">VG-FOOD-ORDERING</span>
                <span class="logo_name" style="font-size:14px; margin-top:-2px">User Registration</span>
            </div>
            <div class="inputbox">
            ...
            <div class="btnbox">
                <a class="backBtn" href="/VG_Food_Ordering/auth/login.php">
